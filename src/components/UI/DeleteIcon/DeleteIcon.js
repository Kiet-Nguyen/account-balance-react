...
const DeleteIcon = () => (
  <svg id="Layer_1" width="100%" height="100%" viewBox="0 0 511.999 511.999" style={{enableBackground: 'new 0 0 511.999 511.999'}}>
    <circle style={{fill: '#ff6542'}} cx="255.999" cy="255.999" r="255.999" />
    <g>
